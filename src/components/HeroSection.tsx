  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-6 text-center">
        {/* Social proof badge */}
        <div className="inline-flex items-center gap-2 glass-card px-4 py-2 mb-8 animate-fade-up" style={{ animationDelay: "0s" }}>
        ...
        {/* Main headline */}
        <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-medium mb-6 animate-fade-up" style={{ animationDelay: "0.1s" }}>
          <span className="block text-foreground">Step into</span>
          <span className="block gradient-text glow-text mt-2">MIRROW World</span>
        </h1>

        {/* Value proposition */}
        <p className="text-xl md:text-2xl text-foreground/90 font-light max-w-2xl mx-auto mb-4 animate-fade-up" style={{ animationDelay: "0.2s" }}>
          Studio-Grade Lighting. Anywhere.
        </p>

        {/* Benefits */}
        <div className="flex flex-wrap justify-center gap-4 mb-8 animate-fade-up" style={{ animationDelay: "0.25s" }}>
        ...
        {/* Description */}
        <p className="text-muted-foreground/80 max-w-xl mx-auto mb-10 animate-fade-up" style={{ animationDelay: "0.3s" }}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-up" style={{ animationDelay: "0.4s" }}>
          <Button 
            size="lg" 
            className="bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-6 text-lg font-medium glow-border transition-all duration-300 hover:scale-105 group"
          ...
          <Button 
            variant="outline" 
            size="lg" 
            className="border-border/50 text-foreground hover:bg-secondary/50 px-8 py-6 text-lg font-medium backdrop-blur-sm group"
        ...
        {/* Urgency */}
        <p className="text-sm text-primary/80 mt-6 animate-fade-up" style={{ animationDelay: "0.5s" }}>
          🔥 Limited stock — 23 sold in the last hour
        </p>

        {/* Scroll indicator */}
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 animate-fade-up" style={{ animationDelay: "0.6s" }}>
          <button 
            onClick={scrollToProducts}
